...
trend_maxmin(
  filter(mammography_county, FIPS!=37081), #Note: filtered out Greensboro because it was tied with Grand Rapids
  mammography_screening,
  zero_start = T,
  rollmean = 3,
  y_title = "Percentage points change",
...
png(path %p% "maxmin.png", 3000, 2400, res = 200, bg = "transparent", type = "cairo")
glptools::trend_maxmin(
  filter(diabetes_prevalence_county, FIPS!=39061), #Note: filtered out Cincinnati because it was tied with Charlotte
  diabetes_prevalence, 
  zero_start = T,
  rollmean = 3,
  order='Ascending',
...
this_title_trend_graphs = "Sexually Transmitted Infections"
this_caption <- "\nSource: Greater Louisville Project
